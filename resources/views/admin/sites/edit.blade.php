...
@section('content_header')
    <div class="row">
        <div class="col-md">
            <h1>Editar Sitio: {{ $site->nombre }}</h1>
        </div>
    </div>
@stop
            ...
            <form action="{{ route('sites.update', $site) }}" method="POST">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text"
                                   ...
                                   value="{{ old('dominio_base', $site->dominio_base) }}"
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text"
                                   ...
                                   value="{{ old('gsc_property', $site->gsc_property) }}"
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-check">
                                <input type="checkbox"
                                       ...
                                       value="1"
                                       {{ old('estado', $site->estado) ? 'checked' : '' }}>
                ...
                <div class="form-group">
                    ...
                    <textarea name="gsc_credentials"
                              ...
                              rows="8"
                              placeholder='Pega aquí el contenido del archivo JSON de credenciales'>{{ old('gsc_credentials', is_array($site->gsc_credentials) ? json_encode($site->gsc_credentials, JSON_PRETTY_PRINT) : $site->gsc_credentials) }}</textarea>
                ...
                <div class="form-group">
                    <button type="submit" class="btn btn-success">
                        <i class="fas fa-save"></i> Actualizar Sitio
                    </button>
